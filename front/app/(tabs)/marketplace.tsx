// file: front/app/%28tabs%29/marketplace.tsx
...
export default function MarketplaceScreen() {
    ...
    // Map backend enum keys to readable names (use translations when available)
    ...
    // Use backend ServiceType keys here so the filter sends the exact enum expected by the API.
