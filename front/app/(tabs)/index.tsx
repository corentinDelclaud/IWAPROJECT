    ...
    return (
        <ScrollView style={{ flex: 1 }}>
            ...
            <ThemedView style={{ backgroundColor: theme.slateCard, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: theme.slateBorder }}>
                ...
                <ThemedText style={{ color: '#9CA3AF', marginTop: 4 , textAlign: 'center'}}>{t('common:home.subtitle')}</ThemedText>
            </ThemedView>

            <ThemedView style={{ marginTop: 16, gap: 12, paddingHorizontal: 16, alignItems: 'center' }}>
                <Link href="/(tabs)/marketplace" style={{ display: 'flex', width: '100%' }}>
                    <ThemedView style={{ width: '100%', backgroundColor: 'rgba(147,51,234,0.15)', borderColor: 'rgba(168,85,247,0.3)', borderWidth: 1, padding: 16, borderRadius: 12 }}>
                ...
                <Link href="/(tabs)/messaging" style={{ display: 'flex', width: '100%' }}>
                    <ThemedView style={{ width: '100%', backgroundColor: 'rgba(59,130,246,0.15)', borderColor: 'rgba(59,130,246,0.3)', borderWidth: 1, padding: 16, borderRadius: 12 }}>
                ...
                <Link href="/(tabs)/profile" style={{ display: 'flex', width: '100%' }}>
                    <ThemedView style={{ width: '100%', backgroundColor: 'rgba(245,158,11,0.15)', borderColor: 'rgba(245,158,11,0.3)', borderWidth: 1, padding: 16, borderRadius: 12 }}>
